  ...
  while(flag)
  {
    ...
    if(contSensor==0)
      ...
      temp18b20_3=celsius;
       ...
       return;  
    //Serial.print(celsius);Serial.print(" ");Serial.print(temp18b20_0);Serial.print(" ");Serial.print(temp18b20_1);Serial.print(" ");Serial.print(temp18b20_2);Serial.print(" ");Serial.println(temp18b20_3);   
    contSensor++;
  }
}
