...
Ws_teste+=("</head>");
Ws_teste+=("<body>");
Ws_teste+=("<div align=center style='width:80%;border:0px;margin:0px;'>");
        ...
        Ws_teste+=("<table style='width:80%;font-size:clamp(0.5em, 0.5em + 0.7vw, 2em);'>");
            Ws_teste+=("<tr align='center'>");
        ...
        Ws_teste+=("<table style='width:80%;text-align: center;'>");
            Ws_teste+=("<tr>");
                Ws_teste+=("<th>COMB</th>");
